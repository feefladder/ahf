...
class TestTablesCreated:
    ...
    func test_init_field_blocks_table():
        database.db.open_db()
        initializer._init_field_blocks_table()
        database.db.close_db()
    ...
    func test_init_livestock_table():
        database.db.open_db()
        initializer._init_livestock_table()
        database.db.close_db()
    ...
    func test_init_upgrades_table():
        database.db.open_db()
        initializer._init_upgrades_table()
